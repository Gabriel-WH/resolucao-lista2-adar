...
1. Crie um vetor com os valores de $e^x \: cos(x)$ $x = ( 3, \: 3.1, \: 3.2,  \:..., \: 6 )$.
...
2. Crie os seguintes vetores.
   ...
   a. $(0.1^3 \times 0.2^1, \: 0.1^6 \times 0.2^4, \: ..., \: 0.1^{36} \times$
   $\:0.2^{34})$
